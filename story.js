...
exports.choices = {
    adj: [
        (0, list_1.list)(1, 2, 3), // 0  start
        (0, list_1.list)(4, 5), // 1
        (0, list_1.list)(5, 6, 7), // 2
        (0, list_1.list)(6, 7), // 3
        (0, list_1.list)(8, 9), // 4
        (0, list_1.list)(8, 10), // 5
        (0, list_1.list)(10, 11), // 6
        (0, list_1.list)(9, 11, 12), // 7
        (0, list_1.list)(13, 14), // 8
        (0, list_1.list)(13, 15), // 9
        (0, list_1.list)(14, 15), // 10
        (0, list_1.list)(14, 16), // 11
        (0, list_1.list)(15, 16), // 12
        (0, list_1.list)(17, 18), // 13
        (0, list_1.list)(17, 19), // 14
        (0, list_1.list)(18, 19), // 15
        (0, list_1.list)(17, 18), // 16
        (0, list_1.list)(), // 17  ENDING
        (0, list_1.list)(), // 18  ENDING
        (0, list_1.list)(), // 19  ENDING
    ],
    size: 19
};
